...
SOURCE_DIR="/Users/lange/Cryptomator/iCloudDrive"
RSYNC_OPTS="--archive --hard-links --whole-file --one-file-system --checksum --verbose --delete"
DIFF_OPTS="--brief --recursive"

n=0
n=$(($n+1)); TARGET_NAME[n]="OneDrive";        TARGET_LIST[n]="/Users/lange/Cryptomator/OneDrive";          CRYPTOMATOR_LIST[n]="YES";
n=$(($n+1)); TARGET_NAME[n]="GoogleDrive";     TARGET_LIST[n]="/Users/lange/Cryptomator/GoogleDrive";       CRYPTOMATOR_LIST[n]="YES";
n=$(($n+1)); TARGET_NAME[n]="Dropbox";         TARGET_LIST[n]="/Users/lange/Cryptomator/Dropbox";           CRYPTOMATOR_LIST[n]="YES";
